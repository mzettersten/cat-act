...
test_array <- d %>% 
  filter(trial_type == "html-button-response-catact") %>%
  select(subject,exclude_participant,trial_type,current_category_training_level,current_category_label_level,current_category_kind,current_hypernym_category_kind,final_choice_array) %>%
...
test_array_options <- d %>% 
  filter(trial_type == "html-button-response-catact") %>%
  select(subject,exclude_participant,trial_type,current_category_training_level,current_category_label_level,current_category_kind,current_hypernym_category_kind,shuffled_test_images,final_choice_array) %>%
