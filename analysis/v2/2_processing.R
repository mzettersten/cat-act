...
data_path <- here("..","..","data","v2","processed", "catact-v2-alldata-anonymized.csv")
write_path <- here("..","..","data","v2","processed")
...
strategy_responses_only <- survey_responses %>%
  ...
  distinct()
write_csv(strategy_responses_only,here(write_path,"catact-v2-strategy-responses.csv"))
...
# write sampling data
write_csv(sampling_data,here(write_path,"catact-v2-sampling-data.csv"))
...
write_csv(test_array_clean,here(write_path,"catact-v2-test-data.csv"))
...
write_csv(test_array_options_clean,here(write_path,"catact-v2-test-data-long.csv"))

#write final data set
write_csv(d,here(write_path,"catact-v2-alldata-processed.csv"))